...
public:
    ...
    // Constructor
    GPProjFactor(const vector<Eigen::Vector2d> &proj_, const vector<int> &id_, const Vector3d &pos_anchor_j_, const std::map<int, Eigen::Vector3d> &corner_pos_3d_, double w_,
