...
class GPLinktrackFactorAutodiff
{
public:

    // Destructor
    ~GPLinktrackFactorAutodiff() {};

    // Constructor
    GPLinktrackFactorAutodiff(double linktrack_, const Vector3d &pos_anchor_i_, const Vector3d &pos_anchor_j_, const Vector3d &offset_, double w_,
    ...
    bool operator()(T const *const *parameters, T *residuals) const
    {
        ...
        residual[0] = w*(diff_j.norm() - diff_i.norm() - linktrack);
