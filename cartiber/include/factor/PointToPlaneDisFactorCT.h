...
#ifndef splio_PIVOTPOINTPLANEFACTORCT_H_
#define splio_PIVOTPOINTPLANEFACTORCT_H_
...
class PointToPlaneDisFactorCT : public ceres::SizedCostFunction<1, 7, 7>
{
public:
    PointToPlaneDisFactorCT() = delete;
    PointToPlaneDisFactorCT(const Eigen::Vector3d &f_, const Eigen::Vector4d &coef,
...
#endif //splio_PIVOTPOINTPLANEFACTORCT_H_
